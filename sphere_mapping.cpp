// *****************************************************************************
// sphere_mapping.cpp                                              Tao3D project
// *****************************************************************************
//
// File description:
//
...
// ----------------------------------------------------------------------------
    : TextureMapping(), ratio(ratio),
      ratioUID(0), lightsUID(0), colorMapUID(0), sphereMapUID(0),
...
// ----------------------------------------------------------------------------
{
    ...
    else
    {
        ...
        sphereMapUID = GL.GetUniformLocation(id, "sphereMap");
